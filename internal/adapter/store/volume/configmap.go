...
func (store *VolumeStore) DeleteConfigMap(configMapName, namespace string) error {
	volumeName := buildVolumeName(configMapName, namespace)
...
func (store *VolumeStore) StoreConfigMap(configMap *corev1.ConfigMap) error {
	volumeName := buildVolumeName(configMap.Name, configMap.Namespace)
...
func buildVolumeName(configMapName, namespace string) string {
